...
class Exercise3TestSuite extends FunSuite {
  ...
  test("Array(1, 2, 3, 4, 5) with swapped elements results in Array(2, 1, 4, 3, 5)") {
    assert(Exercise3.swapArrayPairs(Array(1, 2, 3, 4, 5)) === Array(2, 1, 4, 3, 5))
  }

  test("Array(2, 4, 6, 8, 10, 12, 14, 16, 18) with swapped elements results in Array(4, 2, 8, 6, 12, 10, 16, 14, 18)") {
    assert(Exercise3.swapArrayPairs(Array(2, 4, 6, 8, 10, 12, 14, 16, 18)) === Array(4, 2, 8, 6, 12, 10, 16, 14, 18))
  }
}
